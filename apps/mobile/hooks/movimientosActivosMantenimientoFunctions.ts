...
export async function listMovimientosActivoMantenimiento({
    ...
    try {
        ...
        const response = await authedFetch({
            url: `${apiUrl}/api/activo-mantenimiento/${activoId}/movimientos?m=${marcaId}`,
            init: {
                method: 'GET',
                headers: {
...
export async function createMovimientoActivoMantenimiento({
    ...
    try {
        ...
        const response = await authedFetch({
            url: `${apiUrl}/api/activo-mantenimiento/${activoId}/movimientos`,
            init: {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
...
export async function updateMovimientoActivoMantenimiento({
    ...
    try {
        ...
        const response = await authedFetch({
            url: `${apiUrl}/api/activo-mantenimiento/${activoId}/movimientos/${id}`,
            init: {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
...
export async function deleteMovimientoActivoMantenimiento({
    ...
    try {
        ...
        const response = await authedFetch({
            url: `${apiUrl}/api/activo-mantenimiento/${activoId}/movimientos/${id}?m=${marcaId}`,
            init: {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
