/*
  ...
  - You are about to drop the column `cliente_id` on the `c_control_asistencia` table. All the data in the column will be lost.
  ...
  - Added the required column `division_id` to the `c_control_asistencia` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `c_control_asistencia` DROP COLUMN `cliente_id`,
