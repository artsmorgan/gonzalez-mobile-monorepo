/*
  ...
  - Added the required column `firma_responsable` to the `c_encuesta_cliente` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `c_encuesta_cliente` ADD COLUMN `firma_responsable` LONGTEXT NOT NULL;
