/*
  ...
  - You are about to drop the column `plaza_id` on the `c_acta_entre_producto` table. All the data in the column will be lost.
  - You are about to drop the column `puesto_id` on the `c_acta_entre_producto` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE `c_acta_entre_producto` DROP COLUMN `plaza_id`,
