/*
  ...
  - Added the required column `firma_mecanico` to the `c_mantenimiento_vehiculos_corporativos` table without a default value. This is not possible if the table is not empty.
  - Added the required column `nombre_mecanico` to the `c_mantenimiento_vehiculos_corporativos` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `c_mantenimiento_vehiculos_corporativos` ADD COLUMN `firma_mecanico` LONGTEXT NOT NULL,
    ADD COLUMN `nombre_mecanico` LONGTEXT NOT NULL,
