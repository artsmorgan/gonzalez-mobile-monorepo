...
-- AlterTable
ALTER TABLE `c_incidente` ADD COLUMN `file_audio` LONGTEXT NULL,
    ADD COLUMN `file_image` LONGTEXT NULL;

-- AlterTable
ALTER TABLE `e_actividad_corpo_marcada` ADD COLUMN `file_name` LONGTEXT NULL;
...
-- AlterTable
ALTER TABLE `e_registro_vehiculos` ADD COLUMN `file_name` LONGTEXT NULL,
