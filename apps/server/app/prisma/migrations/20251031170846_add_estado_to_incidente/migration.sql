/*
  ...
  - Added the required column `estado` to the `c_incidente` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `c_incidente` ADD COLUMN `estado` BOOLEAN NOT NULL;
