/*
  ...
  - Added the required column `email_evaluado` to the `c_encuesta_cliente` table without a default value. This is not possible if the table is not empty.
  - Added the required column `firma_evaluado` to the `c_encuesta_cliente` table without a default value. This is not possible if the table is not empty.
  - Added the required column `telefono_evaluado` to the `c_encuesta_cliente` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `c_encuesta_cliente` ADD COLUMN `email_evaluado` VARCHAR(50) NOT NULL,
    ADD COLUMN `firma_evaluado` LONGTEXT NOT NULL,
    ADD COLUMN `telefono_evaluado` VARCHAR(25) NOT NULL;
