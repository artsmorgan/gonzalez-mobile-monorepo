/*
  ...
  - Added the required column `cedula_empleado` to the `c_evaluacion_empleado` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `c_evaluacion_empleado` ADD COLUMN `cedula_empleado` VARCHAR(45) NOT NULL,
