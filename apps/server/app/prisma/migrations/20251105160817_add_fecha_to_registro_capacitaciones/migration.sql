/*
  ...
  - Added the required column `fecha` to the `e_registro_capacitaciones` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `e_registro_capacitaciones` ADD COLUMN `fecha` DATE NOT NULL;
