/*
  ...
  - Added the required column `tipo` to the `c_evaluacion_empleado` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `c_evaluacion_empleado` ADD COLUMN `tipo` VARCHAR(25) NOT NULL,
    MODIFY `created_at` DATETIME NOT NULL;

-- AlterTable
ALTER TABLE `e_registro_capacitaciones` MODIFY `file` LONGTEXT NULL;
