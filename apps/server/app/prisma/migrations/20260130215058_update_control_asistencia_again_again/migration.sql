/*
  ...
  - Added the required column `cliente_id` to the `c_control_asistencia` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `c_control_asistencia` ADD COLUMN `cliente_id` INTEGER NOT NULL;
