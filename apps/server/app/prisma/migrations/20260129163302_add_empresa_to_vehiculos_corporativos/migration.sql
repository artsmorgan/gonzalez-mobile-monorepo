/*
  ...
  - Added the required column `empresa_id` to the `c_vehiculos_corporativos` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `c_vehiculos_corporativos` ADD COLUMN `empresa_id` INTEGER NOT NULL;
