/*
  ...
  - Added the required column `observaciones` to the `c_encuesta_cliente` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `c_encuesta_cliente` ADD COLUMN `observaciones` LONGTEXT NOT NULL;
