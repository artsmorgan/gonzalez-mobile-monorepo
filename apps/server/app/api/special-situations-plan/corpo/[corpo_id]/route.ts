...
export async function GET(
    ...
    try {
        ...
        const records = await prisma.c_plan_atencion_situaciones_especiales.findMany({
            where: {
                corpo_id: corpo_id
            },
            orderBy: {
        ...
        return NextResponse.json({
            status: true,
            message: "Planes para la atención de situaciones especiales obtenidos correctamente",
