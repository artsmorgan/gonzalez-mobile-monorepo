...
export async function GET(
    ...
    try {
        ...
        const records = await prisma.c_registro_tareas_actividades_limpieza.findMany({
            where: {
                corpo_id: corpo_id
            },
            orderBy: {
        ...
        return NextResponse.json({
            status: true,
            message: "Registros de tareas o actividades de limpieza obtenidos correctamente",
