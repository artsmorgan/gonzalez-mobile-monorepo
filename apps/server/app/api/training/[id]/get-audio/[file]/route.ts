...
export async function GET(
    ...
    if (!id || !file) {
        await reportError(req, "api/training/[id]/get-audio/[file]", "GET", 400, "ID o archivo faltante");
    ...
    try {
        ...
        if (!check.allowed) {
            await reportError(req, "api/training/[id]/get-audio/[file]", "GET", 404, "No autorizado");
        ...
        await reportError(req, "api/training/[id]/get-audio/[file]", "GET", 500, errorMessage);
