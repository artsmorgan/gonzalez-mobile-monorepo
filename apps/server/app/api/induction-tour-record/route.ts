    ...
    try {
        ...
        const new_record = await prisma.c_registro_induccion_recorrido.create({
            data: {
                ...
                fecha: fecha || null,
                renglon_edificio: renglon_edificio || null,
                supervisor_cliente: supervisor_cliente || null,
                supervisor_corporacion: supervisor_corporacion || null,
                temas_desarrollados: temas_desarrollados || null,
                aspectos_especificos: aspectos_especificos || null,
