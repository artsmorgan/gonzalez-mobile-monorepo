...
export async function POST(req: NextRequest) {
    try {
        ...
        const new_record = await prisma.c_plan_accion.create({
            data: {
                ...
                nombre_lugar: nombre_lugar || null,
                fecha_inicio_operaciones: fecha_inicio_operaciones || null,
                tareas: tareas || null,
        ...
        return NextResponse.json({ 
            ...
            data: {
                ...
                nombre_lugar: new_record.nombre_lugar,
                fecha_inicio_operaciones: new_record.fecha_inicio_operaciones,
                tareas: new_record.tareas,
