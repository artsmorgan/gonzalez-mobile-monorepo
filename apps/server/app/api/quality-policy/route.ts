...
export async function POST(req: NextRequest) {
    try {
        ...
        const new_record = await prisma.c_politica_calidad.create({
            data: {
                ...
                politica_contenido: politica_contenido || null,
                nombre_aprobado: nombre_aprobado || null,
                firma_aprobado: firma_aprobado || null,
        ...
        return NextResponse.json({ 
            status: true, 
            message: "Política de calidad creada correctamente",
            data: new_record
        }, { status: 200 });
