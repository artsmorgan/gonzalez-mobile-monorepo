    ...
    try {
        ...
        const new_record = await prisma.c_control_asistencia.create({
            data: {
                ...
                total_presentes: total_presentes || null,
                fijos: fijos || null,
        ...
        return NextResponse.json({ 
            ...
            data: {
                ...
                turno: new_record.turno,
                area_piso: new_record.area_piso,
                total_presentes: new_record.total_presentes,
                fijos: new_record.fijos,
                colaboradores: new_record.colaboradores,
