...
export async function POST(req: NextRequest) {
    try {
        ...
        console.log("nombre_evaluador", nombre_evaluador);
        ...
        console.log("--------------------------------");
        if (!marca_id || !nombre_colaborador || !cedula_colaborador || !tipo || !nombre_evaluador || !empleado_id || !evaluador_id || !fecha_ingreso || !fecha_evaluacion || !evaluacion || !firma_evaluador || !firma_empleado) {
