...
export async function GET(
  ...
  try {
    ...
    if (!pncId) {
      await reportError(req, "api/non-conforming-product/[id]/get-audio/[audio]", "GET", 400, "ID no especificado");
    ...
    await reportError(req, "api/non-conforming-product/[id]/get-audio/[audio]", "GET", 500, errorMessage);
