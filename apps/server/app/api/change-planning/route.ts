...
export async function POST(req: NextRequest) {
    try {
        ...
        const new_record = await prisma.c_planificacion_cambios_sgc.create({
            data: {
                ...
                datos_cambio: datos_cambio || null,
                actividades: actividades || null,
                aprobado_por: aprobado_por || null,
                firma_representante: firma_representante || null,
        ...
        return NextResponse.json({ 
            status: true, 
            message: "Planificación de cambios del SGC creada correctamente",
            data: new_record
        }, { status: 200 });
