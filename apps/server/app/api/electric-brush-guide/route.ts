...
export async function POST(req: NextRequest) {
    try {
        ...
        const new_record = await prisma.c_guia_uso_cepillo_electrico.create({
            data: {
                ...
                firma_capacitador: firma_capacitador || null,
        ...
        return NextResponse.json({ 
            status: true, 
            message: "Guía de uso de cepillo eléctrico creada correctamente",
            data: {
                id: new_record.id,
                ...
                capacitador: new_record.capacitador,
                cedula: new_record.cedula,
                fecha: new_record.fecha,
                firma_miscelaneo: new_record.firma_miscelaneo,
                firma_capacitador: new_record.firma_capacitador,
