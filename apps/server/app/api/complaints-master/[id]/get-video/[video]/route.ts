...
export async function GET(
  ...
  try {
    ...
    if (!complaintId) {
      await reportError(req, "api/complaints-master/[id]/get-video/[video]", "GET", 400, "ID no especificado");
    ...
    await reportError(req, "api/complaints-master/[id]/get-video/[video]", "GET", 500, errorMessage);
