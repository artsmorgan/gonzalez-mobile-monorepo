...
export async function GET(
  ...
  try {
    ...
    if (!complaintId) {
      await reportError(req, "api/complaints-master/[id]/get-audio/[audio]", "GET", 400, "ID no especificado");
    ...
    await reportError(req, "api/complaints-master/[id]/get-audio/[audio]", "GET", 500, errorMessage);
