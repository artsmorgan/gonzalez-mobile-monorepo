...
export async function PUT(
    ...
    try {
        ...
        const updateData: any = {
            ...
            tipo_cliente: tipo_cliente !== undefined ? String(tipo_cliente ?? "") : existingRecordObj.tipo_cliente,
            tipo_queja: tipo_queja !== undefined ? String(tipo_queja ?? "") : existingRecordObj.tipo_queja,
            estimacion_dannio: estimacion_dannio !== undefined ? String(estimacion_dannio ?? "") : existingRecordObj.estimacion_dannio,
                ...
                data: {
                    ...
                    cambios: JSON.stringify([{
                        ...
                        before: {
                            ...
                            tipo_cliente: existingRecordObj.tipo_cliente,
                            tipo_queja: existingRecordObj.tipo_queja,
                            estimacion_dannio: existingRecordObj.estimacion_dannio,
