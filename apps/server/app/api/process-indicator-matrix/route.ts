...
export async function POST(req: NextRequest) {
    try {
        ...
        const new_record = await prisma.c_matriz_indicador_procesos.create({
            data: {
        ...
        return NextResponse.json({ 
            status: true, 
            message: "Matriz de indicador de procesos creada correctamente",
            data: {
                id: new_record.id,
