...
export async function POST(req: NextRequest) {
    try {
        ...
        const new_record = await prisma.c_planificacion_mantenimiento_vehiculo.create({
            data: {
                ...
                nombre_vehiculo: nombre_vehiculo || null,
                matricula_vehiculo: matricula_vehiculo || null,
                mantenimientos: mantenimientos ? JSON.stringify(mantenimientos) : null,
        ...
        return NextResponse.json({ 
            status: true, 
            message: "Planificación de mantenimiento creada correctamente",
            data: {
                id: new_record.id,
                ...
                nombre_vehiculo: new_record.nombre_vehiculo,
                matricula_vehiculo: new_record.matricula_vehiculo,
                mantenimientos: new_record.mantenimientos ? JSON.parse(new_record.mantenimientos) : null,
