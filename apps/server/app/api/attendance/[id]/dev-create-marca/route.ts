    ...
    try {
        ...
        const newMarca = await prisma.c_marca_dia.create({
            data: {
                ...
                plaza_id: 6801,
                puesto_id: 1728,
                hora_fin: new Date("1970-01-01 23:00:00"),
                hora_fin_plan: new Date("1970-01-01 23:00:00"),
                hora_inicio: new Date("1970-01-01 09:00:00"),
                hora_inicio_plan: new Date("1970-01-01 09:00:00"),
                horas_duracion: 14,
