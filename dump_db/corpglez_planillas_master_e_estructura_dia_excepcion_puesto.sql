...
--
-- Table structure for table `e_estructura_dia_excepcion_puesto`
--

DROP TABLE IF EXISTS `e_estructura_dia_excepcion_puesto`;
...
CREATE TABLE `e_estructura_dia_excepcion_puesto` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_1F27E2D35035E9DA` (`puesto_id`),
  CONSTRAINT `FK_1F27E2D35035E9DA` FOREIGN KEY (`puesto_id`) REFERENCES `e_estructura_puesto` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `e_estructura_dia_excepcion_puesto`
--

LOCK TABLES `e_estructura_dia_excepcion_puesto` WRITE;
/*!40000 ALTER TABLE `e_estructura_dia_excepcion_puesto` DISABLE KEYS */;
/*!40000 ALTER TABLE `e_estructura_dia_excepcion_puesto` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-07-22 10:42:59
